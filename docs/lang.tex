...
\label{sec:org0ba5899}

\subsection{Sintáxis}
\label{sec:orgaf95c5e}
...
\label{sec:org7759f45}

\subsubsection{Objectos}
\label{sec:org2e7c7d0}
...
\label{sec:orgfa063b8}

\subsection{Instalación}
\label{sec:orgc027b64}
...
las dependencias. \emph{Stack} se encarga de asegurar que es posible construir el proyecto en periodo largo de tiempo, ya que el proyecto se fija a una version del LTS(Long Term Support).
...
\ref{org8e733fb}) en la sección \textbf{repl}.
...
(Configuración véase: \ref{org7abcb7a}).
...
instrucciones son parciales solo sirven de guía. (Véase: \ref{org62464c0})
...
\label{sec:org0add694}

\subsection{Introducción}
\label{sec:orgf193d97}
...
indentación en el código en el caso necesario (Para más información ir: \ref{org0f2aa97}).
...
instrucciones simplificado. (Vease: \ref{org62464c0})
...
\label{sec:orgdf0c77e}

\label{org62464c0} La última fase es la conversión del AST (Abstract Syntax Tree) en conjunto de instrucciones
